...
*/
  ...
  describe("envOverride", () => {
    ...
    it("should coerce the value", () => {
      ...
      expect(
        utils.envOverride("FOO_BAR_BAZ", "notset", s => s.split(""))
      ).to.deep.equal(["s", "e", "t"]);
    ...
    it("should return provided value if coerce fails", () => {
      ...
      expect(utils.envOverride("FOO_BAR_BAZ", "notset", coerce)).to.deep.equal(
        "notset"
      );
  ...
  describe("addSubdomain", () => {
    it("should add a subdomain", () => {
      expect(utils.addSubdomain("https://example.com", "sub")).to.equal(
  ...
  describe("fileExistsSync", () => {
    it("should return true if the file exists", () => {
      expect(utils.fileExistsSync(__filename)).to.be.true;
    });

    it("should return false if the file does not exist", () => {
      expect(utils.fileExistsSync(`${__filename}/nope.never`)).to.be.false;
    });

    it("should return false if the path is a directory", () => {
      expect(utils.fileExistsSync(__dirname)).to.be.false;
    });
  });

  describe("dirExistsSync", () => {
    it("should return true if the directory exists", () => {
      expect(utils.dirExistsSync(__dirname)).to.be.true;
    });

    it("should return false if the directory does not exist", () => {
      expect(utils.dirExistsSync(`${__dirname}/nope/never`)).to.be.false;
    });

    it("should return false if the path is a file", () => {
      expect(utils.dirExistsSync(__filename)).to.be.false;
    });
  });
});
